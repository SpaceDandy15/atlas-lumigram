...
type AddPostScreenProps = {
  onPostAdded?: (newPost: QueryDocumentSnapshot<DocumentData>) => void;
};
...
export default function AddPostScreen({ onPostAdded }: AddPostScreenProps) {
  ...
  const pickImage = async () => {
    ...
    if (!permission.granted) return Alert.alert('Permission Denied', 'Camera roll access is required.');
...
const styles = StyleSheet.create({
  ...
  imagePicker: { width: '100%', height: 250, borderRadius: 10, borderWidth: 1, borderColor: '#ccc', justifyContent: 'center', alignItems: 'center', marginBottom: 20, backgroundColor: '#f9f9f9' },
